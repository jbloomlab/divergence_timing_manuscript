...
These examples, along with other similar discrepancies with measles virus~\citep{furuse2010origin, rhazes1848treatise}\jdbcomment{add paper specifically emphasizing discrepancy}, coronavirus~\citep{wertheim2013case}, and hepatitis B virus~\citep{fares2002revised}, indicate that phylogenetic methods have a systematic bias toward underestimation of deep branches.
...
These models explicitly account for the fact that different protein sites prefer different amino acids, and so can improve phylogenetic estimates when there are deep branches~\jdbcomment{cite any papers that show this is true. Maybe the CAT model and the one on long-branch attraction?}.
