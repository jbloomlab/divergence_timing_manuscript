...
External computer programs used were \texttt{phydms}~\citep{hilton2017phydms} version 2.2.2, \texttt{pyvolve}~\citep{spielman2015pyvolve} version 0.8.7, \texttt{PhyloBayes-MPI}~\citep{rodrigue2014site} version 1.8, \texttt{RAxML}~\citep{stamatakis2006raxml} version 8.2.11 (available at \url{https://github.com/stamatak/standard-RAxML}), \texttt{ggplot2}~\citep{wickham2016ggplot2}, \texttt{ggtree}~\citep{yu2017ggtree}, \texttt{ggseqlogo}~\citep{wagih2017ggseqlogo}, and \texttt{snakemake}~\citep{koster2012snakemake} version 3.11.2.
