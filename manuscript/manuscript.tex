...
We quantitatively plotted the branch lengths in \ref{fig:empirical_trees} for comparison.
...
The site-specific amino-acid preference set defining the ExpCM is labeled above each each plot.
