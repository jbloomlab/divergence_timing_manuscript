...
\textcolor{red}{Here we will consider mutation-selection models where the site-specific selection is assumed to act solely at the protein level (different codons for the same amino acid are treated as selectively equivalent)}.
...
\textcolor{red}{An alternative strategy to deal with site-specific amino-acid preferences is to consider them formally random-effects across sites rather than parameters, and to infer them using Bayesian inference~\citep{lartillot2004bayesian, rodrigue2014site}. 
