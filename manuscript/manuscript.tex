...
There are nine parameters describing the nucleotide frequencies at each codon site (the nucleotides are constrained to sum to one at each codon position) \skhcomment{which} are calculated from the empirical alignment frequencies. 
