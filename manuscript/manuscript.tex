...
Blue and orange denote branches that terminate at the H1 and H3 deep mutational scanning reference sequences respectively. 
\skhcomment{leading to? from? terminate at?}
...
For the average preference set, we took the normalized pairwise average of the H1 and H3 preferences. 
The preference for every amino acid, $a$, at every site, $r$, in the average preference set is
\begin{equation}
\label{eq:pi_avg}
\pi_{r,a,\rm{(H1+H3\ avg)}} = \frac{\pi_{r,a,\rm{H1}} + \pi_{r,a,\rm{H3}}}{\sum_{a^{\prime}} \pi_{r,a^{\prime},\rm{(H1+H3\ avg)}}}
\end{equation}
