#!/bin/sh
# properties = {"params": {"r": "8", "prefix": "_WSN_high_0_8", "tree": "../HA/branch_lengths/phydms/WSN_high_0_ExpCM_HA_Doud_prefs_tree.newick"}, "input": [], "output": ["_WSN_high_0_8_simulatedalignment.fasta"], "rule": "simulate_alignment", "local": false, "threads": 1, "cluster": {}, "resources": {}, "jobid": 14}
cd /fh/fast/bloom_j/computational_notebooks/skhilton/2017/divergence_timing_manuscript/analysis/simulations && \
/app/python3/3.4.1/bin/python3.4 -m snakemake _WSN_high_0_8_simulatedalignment.fasta --snakefile /fh/fast/bloom_j/computational_notebooks/skhilton/2017/divergence_timing_manuscript/analysis/simulations/Snakefile \
