...
We used \texttt{PhyloBayes-MPI} program \texttt{readpb_mpi} to compute the majority-rule consensus tree and the posterior average site-specific amino-acid preferences. 
