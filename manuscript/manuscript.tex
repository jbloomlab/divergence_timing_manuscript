...
\begin{figure}
\centerline{\includegraphics[width=0.7\textwidth]{figures/empirical_scatter.pdf}}
...
Each column has ExpCMs defined by a different deep mutational scanning amino-acid preference set. 
(A) The ExpCM defined by the H1, H3, or (H1+H3) average deep mutational scanning amino-acid preferences estimated longer branches from reference sequence used in the deep mutational scanning experiment. 
