...
These preferences are only one snapshot of the functional constraint and do not capture any of the changes over time. 
...
The first challenge is how to efficiently evaluate these inherently more complex models mathematically so the models can be applied to large phylogenetic trees. 
The second challenge is developing the correct function to model shifting preferences. 
One strategy to to account for context-dependence is to evaluate amino-acid changes as how they might affect protein structure.
