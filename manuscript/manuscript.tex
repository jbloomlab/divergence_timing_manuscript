...
{\bf Tree diameter for trees in \ref{fig:empirical_trees}.}
The branch lengths are in average codon substitutions per site. 
\skhcomment{finish table legend}
} 
     \begin{tabular}{cccccccccc}
        \hline
         Model & Tree diameter & {\shortstack{Percentage increase compared\\ to GY94 tree diameter}} \\ \hline
         GY94 & 11.42 & 0\%\\
         ExpCM(H1) & 14.11& 23\%\\
         ExpCM(H3) & 15.50 & 36\%\\
         ExpCM(H1+H3 avg) & 19.08 & 67\%\\
         GY94 + $\Gamma\omega$ & 19.13 & 68\%\\
         ExpCM(H1) + $\Gamma\omega$ & 25.20 & 121\% \\
         ExpCM(H3) + $\Gamma\omega$ & 26.56 & 133\% \\
         ExpCM(H1+H3 avg) + $\Gamma\omega$ & 29.82 & 161\% \\
      \end{tabular}
\end{supptable}
\clearpage 
...
\skhcomment{finish legend}
} 
     \begin{tabular}{ccc}
        \hline
         Model & Parameters \\ \hline\hline
