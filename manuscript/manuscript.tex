...
The invariance of the asymptotic sequence identity under different schemes for modeling $\omega$ is a fundamental feature of the mathematics of this type of reversible substitution models.
...
This confidence in the \texttt{RAxML}(GTRCAT)-inferred tree is certainly not universal and in other cases more complex, biologically-realistic models may be necessary for accurate topology inference. 
For instance, others have shown that models with site-specific amino-acid preferences can avoid topological errors such as long-branch attraction~\citep{lartillot2007suppression}.
