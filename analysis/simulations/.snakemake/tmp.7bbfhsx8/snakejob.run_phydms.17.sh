#!/bin/sh
# properties = {"resources": {}, "params": {}, "input": ["_WSN_high_0_1_simulatedalignment.fasta"], "threads": 1, "jobid": 17, "rule": "run_phydms", "output": ["phydms/WSN_high_0_1/modelcomparison.md", "phydms/WSN_high_0_1/"], "cluster": {}, "local": false}
...
--wait-for-files _WSN_high_0_1_simulatedalignment.fasta /fh/fast/bloom_j/computational_notebooks/skhilton/2017/divergence_timing_manuscript/analysis/simulations/.snakemake/tmp.7bbfhsx8 --latency-wait 180 \
--benchmark-repeats 1 \
--force-use-threads --wrapper-prefix https://bitbucket.org/snakemake/snakemake-wrappers/raw/ \
   --nocolor \
--notemp --quiet --no-hooks --nolock --force-use-threads  --allowed-rules run_phydms  && touch "/fh/fast/bloom_j/computational_notebooks/skhilton/2017/divergence_timing_manuscript/analysis/simulations/.snakemake/tmp.7bbfhsx8/17.jobfinished" || (touch "/fh/fast/bloom_j/computational_notebooks/skhilton/2017/divergence_timing_manuscript/analysis/simulations/.snakemake/tmp.7bbfhsx8/17.jobfailed"; exit 1)
