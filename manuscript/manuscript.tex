...
Under the assumption of a molecular clock, branch lengths on the phylogenetic tree can be transformed into estimates of time. 
When a calibration points exists, these timing estimates of evolutionary events can be placed on an absolute timescale. 
